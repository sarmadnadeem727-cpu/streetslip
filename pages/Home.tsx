...
const Home: React.FC = () => {
  ...
  const marqueeText = "FREE SHIPPING FOR LAUNCH WEEK ONLY • TRUST THE DRIP • SECURED COD • LIMITED DROPS LIVE NOW • FREE SHIPPING FOR LAUNCH WEEK ONLY • ";
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-4 pt-16 pb-32 sm:pb-60 bg-[#050505]">
        ...
        <div className="relative z-10 text-center max-w-7xl mx-auto w-full">
          ...
          >
            ...
            <span className="text-[#00ff88] font-mono font-bold text-[10px] sm:text-sm tracking-[0.2em] uppercase">VERIFIED AUTHENTIC • SECURE COD</span>
          </motion.div>

          <div className="flex flex-col justify-center items-center gap-6 sm:gap-10 mb-14 sm:mb-20 mt-4 sm:mt-12 relative z-20">
            <div className="relative scale-110 sm:scale-125">
              <RGBGlitchTitle text="STREET SLIPP" className="tracking-[0.2em] sm:tracking-[0.3em]" />
            </div>
            <HypeZipTie />
          </div>
